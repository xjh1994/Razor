...
/**
 * Changed at 2016.09.22:  add "+ File.separator" to SAVEPATH
 */
class UpdateManager {
    ...
    private static final String SAVEPATH = Environment.getExternalStorageDirectory().getPath() + File.separator;
